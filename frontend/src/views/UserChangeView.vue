...
const handleChange = () => {
  ...
  fetch("http://ax1.axiros.hr:8080/user/change", {
    ...
    .then((res) => {
      console.log(res)
      if (!(res.status == 200)) {
        alert("Wrong password, can't apply changes!");
        throw Error("Wrong password, can't apply changes!");
      }
      return res.json();
      console.log(res);
    })
      ...
      <div class="card login-form">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-labeled btn-danger mx-1" @click="backToHomepage">
          ...
          <h2 class="card-title text-center">Change your username and password</h2>
          <div class="card-text">
            <form class="row g-3">
              <div class="col-12">
              ...
              <button type="submit" @click="handleChange" class="btn btn-dark w-100 m-1">
                Save changes
              </button>
            </form>
          </div>
