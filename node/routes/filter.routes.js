...
router.post("/", async (req, res) => {
  ...
  let qString =
    "select post.postid, post.posttitle, post.postdescription, post.timeofcreation, post.creatoruserid, post.categoryid from post natural join category natural join course natural join study_programme where programename like '" +
    programename +
